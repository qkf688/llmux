...
func GetProviderBlacklist(c *gin.Context) {
	...
	if err != nil {
		httpresp.InternalServerError(c, "Failed to get blacklist: "+err.Error())
		return
	}
	...
	httpresp.Success(c, map[string]interface{}{"blacklisted_ids": ids})
}
...
func UpdateProviderBlacklist(c *gin.Context) {
	...
	if err != nil {
		httpresp.InternalServerError(c, "Failed to update blacklist: "+err.Error())
		return
	}

	httpresp.Success(c, map[string]interface{}{"updated": rowsAffected})
}
